...
from qp_crm.shared.config import BASE_DIR, APP_DATA_DIR, DATABASE, IMAGE_DIR, STATIC_DIR
...
def init_db():
    ...
    from qp_crm.shared.schema import create_pricing_tables
...
def migrate_schema():
    ...
    from qp_crm.shared.schema import migrate_pricing
...
# Standalone dev runs now need the full package form:
# `python -m qp_crm.pricing.app`.
