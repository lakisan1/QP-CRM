...
from qp_crm.shared.config import BASE_DIR
...
# Anchored at the repo root via shared.config BASE_DIR: before the qp_crm/
# package move this was dirname(HERE) (rent/ sat directly under the root);
# the "excell Rent calc" folder stays at the root, NOT inside qp_crm/.
DOCX_DIR = os.path.join(BASE_DIR, "excell Rent calc", "word documents")
