...
from qp_crm.shared.config import BASE_DIR, APP_DATA_DIR, DATABASE, APP_ASSETS_DIR, STATIC_DIR
...
from qp_crm.services.rent_service import (
    pmt,
    _add_months,
    calculate_rent,
    generate_schedule,
...
def init_db():
    ...
    not schema."""
    from qp_crm.shared.schema import create_rent_tables, migrate_rent_tables
